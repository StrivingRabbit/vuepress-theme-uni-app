	...
	<div id="docsearch">
		...
		>
			<span class="DocSearch-Button-Container">
				<svg width="18" height="18" class="DocSearch-Search-Icon" viewBox="0 0 20 20">
					<path
			...
			<span class="DocSearch-Button-Keys">
				<span style="border: 1px solid #2e2e32;padding: 2px 4px;border-radius: 4px;">{{ isMac ? '⌘ K' : 'Ctrl K' }}</span>
			</span>
		</button>
	</div>
</template>
...
<script>
	...
	export default {
		...
		computed: {
			searchText() {
				return this.$lang === LOCALE_ZH_HANS ? '搜索' : 'Search';
			},
			isMac() {
