...
<template>
  <Popover>
    <template #reference>
      <span class="info">
        <svg v-if="status === SUPPORTED" :width="iconWidth" :height="iconWidth" t="1716284589535" class="icon"
          viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6703" fill="#0B6316">
        ...
        <svg v-if="status === NOT_SUPPORTED" :width="iconWidth" :height="iconWidth" t="1716284801363" class="icon"
          viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7267" fill="#86261A">
          <path
